...
--topic-arn arn:aws:sns:us-east-1:000000000000:resultado-sessao-topic \
--protocol sqs \
--notification-endpoint arn:aws:sqs:us-east-1:000000000000:resultado-sessao-mensagem-whats-queue \
